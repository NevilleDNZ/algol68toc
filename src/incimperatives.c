...
A_ISTRUCT(A68_CHAR ,69,A68t38);
typedef struct A68t38  A68_38 ;    /* STRUCT 69 CHAR */
struct A68t40{
A68_INT  Nochars;
A_PAD_INT(PAD_1)
A68_INT  Nocases;
...
static A68_38   XAAACTR = {"$Id: incimperatives.c,v 1.5.2.4 2004/09/27 03:04:18 teshields Exp $"}; 
A_GISVEC(A68_VC ,YAAACTR,XAAACTR,69)
