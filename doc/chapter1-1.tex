...
\ix{command line} because a graphical user interface is usually too
cumbersome to
...
\ix{integer}, the
\hx{largest positive integer}{integer!largest positive} which
can be manipulated by \verb|a68toc| is
...
\hx{``object code''}{code!object}.  This is then converted by a
program called a
