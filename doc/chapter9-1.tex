...
output book \verb|outbook|.\hylabel{trans-term-a}\ans Notice that the
...
\ix{null string} (denoted by \verb|""|). The procedure
\ixtt{skip terminators} with header
\begin{verbatim}
...
Each string is identified by what is called an
