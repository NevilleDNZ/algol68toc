...
3&#XB7;14159&#XD7;10<sup>-43</sup> has 3&#XB7;14159 as a mantissa and -43
as an exponent.  Because real numbers are stored in \ix{binary}
(radix~2), the mantissa is stored as a value in the range
$1&le;value&lt;2 with the exponent adjusted appropriately.

There are a number of identifiers declared in the
\ix{standard prelude}, known as
