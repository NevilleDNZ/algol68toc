...
\ans Deproceduring and dereferencing (not weakly-dereferencing).
'
...
\ix{assigning operators}---see section~\hyref{name-assops}).
If an assignment is to
...
\hx{\textbf{descriptor}}{descriptor} and the actual elements. The
